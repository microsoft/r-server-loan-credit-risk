...
<p/>
 <strong>deployment_main.R</strong> will create a web service and test it on the edge node.  If you wish, you can also download the file <strong>campaign_web_scoring.R</strong> and access the web service on any computer with Microsoft R Server 9.0.1 installed.  
<p/>
<div class="alert alert-info" role="alert">
Before running  <strong>deployment_main.R</strong> on any computer, you must first connect to edge node from that computer.
